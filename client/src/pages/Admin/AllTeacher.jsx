...
const AllTeacher = () => {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_APIA}/teacher`)
    ...
    <div className="flex h-screen">
       <aside className="hidden md:flex  fixed top-0 left-0 w-full md:w-44 bg-green-900 text-white flex flex-col h-screen mt-0 mb-0">
        ...
        <nav className="flex flex-col space-y-2">
          ...
          <NavLink to="/admin/teachers" className="flex items-center space-x-2 text-gray-300 hover:text-white px-4 py-2 rounded-lg bg-green-700 font-bold ">
