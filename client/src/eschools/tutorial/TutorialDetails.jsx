...
const TutorialDetails = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get(`${import.meta.env.VITE_API_TU}/atutorial/${slug}`)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    const fetchClickCount = async () => {
      const response = await fetch(`${import.meta.env.VITE_API_TU}/get-clicks/`);
      const data = await response.json();
      console.log(data.length)
      setClickCount(data.length);
    };
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_TU}/${slug}/shares`)
      .then((response) => {
  ...
  const handleShareClick = async () => {
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_TU}/${slug}/shares`
      );
    ...
    const handleAddComment = () => {
        ...
        axios
          .post(`${import.meta.env.VITE_API_TU}/${slug}/comments`, comment)
          .then(() => {})
