...
const BookshopDetails = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get(`${import.meta.env.VITE_API_B}/abook/${slug}`)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    const fetchClickCount = async () => {
      const response = await axios.get(`${import.meta.env.VITE_API_B}/get-clicks/${slug}`);
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_B}/${slug}/shares`)
      .then((response) => {
  ...
  const handleShareClick = async () => {
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_B}/${slug}/shares`
      );
  ...
  const handleAddComment = () => {
    ...
    axios
      .post(`${import.meta.env.VITE_API_B}/${slug}/comments`, comment)
      .then(() => {})
