...
const StoreDetails = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get(`${import.meta.env.VITE_API_S}/astore/${slug}`)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    const fetchClickCount = async () => {
      const response = await fetch(`${import.meta.env.VITE_API_S}/get-clicks/`);
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_S}/${slug}/shares`)
      .then((response) => {
  ...
  const handleShareClick = async () => {
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_S}/${slug}/shares`
      );
    ...
    const handleAddComment = () => {
        ...
        axios
          .post(`${import.meta.env.VITE_API_S}/${slug}/comments`, comment)
          .then(() => {})
