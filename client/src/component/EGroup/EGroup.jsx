...
console.log("my infor!!!",userInfo)
  ...
  const fetchGroupData = async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_VERCEL}/api/groups/getGroupBySlug/${slug}`
      );
  ...
  const fetchDiscussions = async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_VERCEL}/api/groups/getDiscussionsByGroup/${groupId}`
      );
  ...
  const checkMembership = async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_VERCEL}/api/groups/members/${groupId}`,
        { email }
      );
  ...
  const handleJoinGroup = async () => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_VERCEL}/api/groups/join/${groupId}`, {
        email: email,
        id: userId,
        name: name,
      });
  ...
  const handleLeaveGroup = async () => {
    ...
    setMembershipLoading(true);
    try {
      await axios.post( `${import.meta.env.VITE_API_VERCEL}/api/groups/leave/${groupId}`, {
        email: email,
      });
  ...
  const handleDiscussionSubmit = async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_VERCEL}/api/discussions/createDiscussion`,
        {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-blue-300 via-green-100 to-green-500 rounded-xl text-black shadow-lg mb-8">
